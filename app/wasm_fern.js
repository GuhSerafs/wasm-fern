...
* @param {number} it
*/
export function render_barnsley_fern(canvas, it) {
    _assertClass(canvas, Canvas);
    wasm.render_barnsley_fern(canvas.__wbg_ptr, it);
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_random_b74d7aa0affd2b7f = typeof Math.random == 'function' ? Math.random : notDefined('Math.random');
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm_fern_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
